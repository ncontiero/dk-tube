...
export const clerkTheme = createTheme({
  ...
  elements: {
    ...
    menuButton:
      "bg-secondary/60 text-foreground hover:bg-secondary hover:text-foreground active:bg-secondary focus:ring-2 focus:ring-ring",
    menuList: "bg-secondary",
    menuItem:
      "text-foreground bg-background/40 hover:text-foreground hover:bg-background active:bg-secondary",
    ...
    // Footer
    footer:
      "[&>.cl-internal-1dauvpw]:bg-primary [&>.cl-internal-1dauvpw]:text-primary-foreground dark:[&>.cl-internal-1dauvpw]:bg-primary",
    footerAction:
      "bg-card/80 w-full flex justify-center pt-2 border-t border-foreground/30 dark:border-foreground/10 dark:bg-card/95",

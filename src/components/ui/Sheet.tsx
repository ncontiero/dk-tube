...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      `
        fixed inset-0 z-[99999] bg-black/80 data-[state=open]:animate-in data-[state=open]:fade-in-0
...
const sheetVariants = cva(
  `
    fixed z-[99999] gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=closed]:duration-300
    data-[state=closed]:animate-out data-[state=open]:duration-500 data-[state=open]:animate-in
  `,
  {
    variants: {
      side: {

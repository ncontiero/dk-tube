/* eslint-disable tailwindcss/no-unknown-classes */
"use client";
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn(
          `
            absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 duration-200 ease-linear after:absolute after:inset-y-0
      ...
      <main
        ...
        className={cn(
          ...
          `
            ...
            md:peer-data-[variant=inset]:shadow md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2
          `,
          className,
        )}
        {...props}
    ...
    <Comp
      ...
      className={cn(
        `
          ...
          ring-sidebar-ring duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0
        `,
...
const sidebarMenuButtonVariants = cva(
  `
    ...
    ring-sidebar-ring duration-200 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2!
    ...
    <Comp
      ...
      className={cn(
        `
          ...
          outline-none ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground
